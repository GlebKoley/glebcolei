   ...
   return (
      <div className="main-wrapper">
         <div className="flex flex-col">
            <div className="mobile:gap-[30px] mobile:mb-10 tablet:mb-10 mb-4 flex flex-col items-center gap-2.5 text-center">
               <h2
                  dangerouslySetInnerHTML={{ __html: htmlTitle }}
                  className="description-22 leading-6 text-[#c8c8c8]"
               />
               <Link
                  href={link.slug ?? {}}
            ...
            <div className="mobile:flex mobile:gap-5 tablet:gap-10 hidden flex-row px-4">
               <div className="w-full">{renderLeftCardContent()}</div>
            ...
            <div className="mobile:hidden">
               <Carousel cards={[1, 2]}>
                  <div className="w-full shrink-0">{renderLeftCardContent()}</div>
