...
import { TextBlockWithAnimatedIconSlice } from '@/lib/types/slices';
import renderTwoGradientBlobs from '@/lib/utils/renderTwoGradientBlobs';

const TextBlockWithAnimatedIcon = ({ data }: { data: TextBlockWithAnimatedIconSlice }) => {
   ...
   return (
      <div className="main-wrapper tablet:gap-10 mobile:max-w-[1150px] relative max-w-full gap-3 text-center">
         ...
         <AnimateIcon src="/react-icon-white.svg" />
      </div>
   );
};
