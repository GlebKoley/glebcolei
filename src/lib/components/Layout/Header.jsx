...
const Header = ({ links = [] }) => {
   ...
   return (
      <>
         <header
            className={`tablet:pb-2 desktop:pb-0 tablet:pt-5 tablet:justify-self-center tablet:bg-transparent tablet:border-0 fixed z-50 w-full ${isMainPage ? 'bg-mainBlack/70 border-b border-white/10' : ''} px-4 pt-3 pb-1.5`}
         >
